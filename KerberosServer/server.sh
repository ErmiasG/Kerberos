...
#cat /vagrant/KerberosServer/spnego/krb5.ini > /etc/krb5.ini
#cat /vagrant/KerberosServer/spnego/spnego.conf > /etc/spnego.conf
#cat /vagrant/KerberosServer/spnego/spnego.properties > /etc/spnego.properties
